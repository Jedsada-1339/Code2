...
fetchData(null, data => {
    ...
    document.title = `${title} - Food lover`;
    ...
    tags.map(tag => {
        ...
        tagElements += `
            <a href="./recipes.html?${type}=${tag.toLowerCase()}" 
        ...
        <div class="detail-content">
            ...
            <div class="title-wrapper">
                ...
                <button class="btn btn-secondary has-state has-icon ${isSaved ? "saved" : "removed"}" onclick="saveRecipe(this, '${recipeId}')">
                    ...
                    <span class="material-symbols-outlined bookmark_add" aria-hidden="true">bookmark_add</span>
            ...
            <div class="datail-author label-large">
